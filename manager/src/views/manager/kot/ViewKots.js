...
const ViewKots = () => {
  ...
  const fetchOrderData = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API}/kot/show?order_source=Manager,Captain`, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
