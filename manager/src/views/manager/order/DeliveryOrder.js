...
import { getOrderById, getUserTaxInfo, createOrUpdateDeliveryOrder, createOrUpdateDineInOrder } from 'api/orderService';
...
const DeliveryOrder = () => {
  ...
  const hasUnsavedChanges = () => {
    ...
    console.log('customer info changed', customerInfoChanged, customerInfo, initial.customerInfo);

    return itemsChanged || customerInfoChanged;
  };

  // Update isDirty only after data is fully loaded
  useEffect(() => {
