...
export default function ManagePayroll() {
    ...
    const editNetPreview = () => {
        ...
        const earned = (editingPayroll.base_salary / safeDays) * editingPayroll.present_days;
                    ...
                    <div className="page-title-container">
                        <Row className="align-items-center">
                            ...
                            <Col xs="12" md="5" className="d-flex justify-content-end gap-2">
                                <Button variant="primary" as={Link} to="/staff/payroll/generate">
                    ...
                    <Card className="mb-4">
                        <Card.Body>
                            <Row className="g-3 align-items-end">
                                ...
                                <Col xs={12} md={2}>
                                    <Button variant="outline-primary" onClick={fetchSummary} disabled={loading} className="w-100">
                    ...
                    {selectedIds.size > 0 && (
                        <div className="d-flex align-items-center gap-2 mb-3 p-3 bg-light rounded">
                            ...
                            <Button
                                ...
                                disabled={isMarkingPaid}
                            >
                                <CsLineIcons icon="undo" className="me-1" />Mark Unpaid
                            </Button>
                            <Button
                                                ...
                                                <tr key={staff._id} className={selectedIds.has(payroll?._id) ? 'table-primary' : ''}>
                                                    ...
                                                    {payroll ? (
                                                        <>
                                                            ...
                                                            <td className="text-end">₹{payroll.base_salary.toLocaleString('en-IN')}</td>
                                                            <td className="text-end text-success">₹{payroll.earned_salary.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
                                                            <td className="text-end text-primary">₹{payroll.overtime_pay.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
                                                            <td className="text-end">₹{payroll.bonus.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
                                                            <td className="text-end text-danger">₹{payroll.deductions.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
                            ...
                            <div className="bg-light rounded p-3 mb-4">
                                <Row>
                                    <Col xs={4} className="text-center">
                                        ...
                                        <div className="fw-bold">₹{editingPayroll.base_salary.toLocaleString('en-IN')}</div>
                                    </Col>
                                    <Col xs={4} className="text-center">
