  ...
  return (
    <div className="container-fluid qsr-page-container">
      <div className="qsr-page-title-container">
        <Row>
          <Col xs="12" md="7">
            <h1 className="qsr-page-title">Payroll Global Settings</h1>
            <nav className="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul className="breadcrumb pt-0">
                ...
                <li className="breadcrumb-item">
                  <a href="/staff/payroll">Payroll</a>
                </li>
              </ul>
            </nav>
          </Col>
      ...
      <Row>
        ...
        <Col xl="6" className="mb-5">
          ...
          <Card>
            <Card.Body>
              <p className="text-muted mb-4">Set the global fallback percentages and amounts. Staff can still have individual overrides in their profiles.</p>
              <Form>
