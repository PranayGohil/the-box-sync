                    ...
                    <div className="page-title-container">
                        <Row className="align-items-center">
                            ...
                            <Col xs="12" md="5" className="d-flex justify-content-end gap-2">
                                <Button variant="outline-primary" as={Link} to="/payroll">
                        ...
                        >
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                ...
                                <Button
                                    variant="success"
                                    size="sm"
                                    onClick={() => history.push(`/payroll/${month}/${year}`)}
                                >
                                    ...
                                    <Table className="mb-0" hover>
                                        <thead className="table-light">
                                            <tr>
                                                ...
                                                <th style={{ minWidth: '120px' }}>OT Hours</th>
                                                <th className="text-end">OT Rate/hr</th>
                                                <th className="text-end">OT Pay</th>
                                                <th style={{ minWidth: '120px' }}>Bonus</th>
                                                <th style={{ minWidth: '120px' }}>Deductions</th>
