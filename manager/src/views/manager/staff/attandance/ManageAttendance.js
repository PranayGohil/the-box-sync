    ...
    <>
      ...
      <div className="container-fluid qsr-page-container">
        ...
        {error && (
          <Alert variant="danger" className="mb-4">
            ...
            {error}
            <Button variant="outline-danger" size="sm" className="ms-3" onClick={fetchTodayAttendance} disabled={loading.initial}>
              Retry
            </Button>
          </Alert>
        )}
      ...
      <Modal show={showActionModal} onHide={() => setShowActionModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title>
            <CsLineIcons icon={actionType === 'checkin' ? 'login' : actionType === 'checkout' ? 'logout' : 'user-block'} className="me-2" />
