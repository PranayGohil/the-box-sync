          ...
          <Row className="g-3 align-items-center">
            ...
            <Col xs={12} lg={5} className="d-flex flex-wrap justify-content-start justify-content-lg-end gap-2 mt-3 mt-lg-0">
              <Button
                ...
                className="btn-action rounded-pill px-4 fw-bold border-2"
              >
              ...
              {inventory.status === 'Requested' && (
                <Button
                  ...
                  onClick={() => history.push(`/operations/edit-inventory/${id}`)}
                  className="btn-action rounded-pill px-4 fw-bold border-2"
                >
        ...
        <Card className="section-card border-0">
          ...
          <div className="d-none d-lg-block">
            <div className="item-header-row">
              ...
              <div style={{ flex: 2 }} className="text-end">
                Price
              </div>
            </div>
                  ...
                  <Col key={idx} xs={12} md={4} lg={3}>
                    <div className="file-card h-100">
                      <div
                        ...
                        style={{ height: '150px', background: '#f8fafc', borderRadius: '12px' }}
                      >
                        {isPdf ? (
