                      ...
                      <tr key={log._id}>
                        ...
                        <td className="align-middle">
                          <Badge
                            ...
                            text={log.wastage_type === 'other' ? 'dark' : undefined}
                          >
                            {log.wastage_type}
                          </Badge>
                        </td>
                        <td className="align-middle text-muted text-small" style={{ maxWidth: 180 }}>
                          {log.reason || '—'}
                        </td>
            ...
            {logs.length > 0 && (
              <Card.Footer className="py-2">
                <small className="text-muted">
                  To delete a wastage entry, contact Admin. Only Admin can remove records.
                </small>
              </Card.Footer>
            )}
          </Card>
