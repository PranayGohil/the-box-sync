                      ...
                      <tr key={item.item_name} className={item.wastage_percent > 20 ? 'table-danger' : ''}>
                        ...
                        <td className="align-middle">
                          {item.wastage_percent > 0 ? (
                            <Badge bg={item.wastage_percent > 20 ? 'danger' : item.wastage_percent > 10 ? 'warning' : 'success'}>{item.wastage_percent}%</Badge>
                          ) : (
                    ...
                    <tbody>
                      {reportData.reorderSuggestions
                        ...
                        .map((item) => (
                          <tr
                            key={item.item_name}
                            className={item.days_until_stockout !== null && item.days_until_stockout <= 1 ? 'table-danger' : 'table-warning'}
                          >
                            <td className="align-middle fw-semibold ps-3">{item.item_name}</td>
                            ...
                            <td className="align-middle">
                              {item.avg_daily_usage} {item.unit}/day
                            </td>
                            <td className="align-middle">
