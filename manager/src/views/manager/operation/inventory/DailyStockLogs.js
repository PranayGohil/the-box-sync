    ...
    <div className="admin-daily-stock-logs-stock-container pb-5">
          ...
          <Row className="g-0 align-items-center">
            ...
            <Col xs="auto">
              <div className="d-flex gap-2 flex-wrap justify-content-end">
                <Button
                  onClick={() => history.push('/operations/daily-opening-stock')}
                  className="manage-menu-custom-btn-outline shadow-sm border-0 px-3 py-2"
                  style={{ color: '#23b3f4' }}
                >
                  <CsLineIcons icon="login" size="18" className="me-2" /> Opening Stock
                </Button>
                <Button
                  onClick={() => history.push('/operations/daily-closing-stock')}
                  className="manage-menu-custom-btn-outline shadow-sm border-0 px-3 py-2 text-success"
                >
          ...
          <Row className="g-2 align-items-end">
            <Col md={3}>
              <div>
                ...
                <Form.Control
                  type="date"
                  className="admin-daily-stock-logs-modern-input w-100"
                  value={fromDate}
            ...
            <Col md={3}>
              <div>
                ...
                <Form.Control type="date" className="admin-daily-stock-logs-modern-input w-100" value={toDate} onChange={(e) => setToDate(e.target.value)} />
              </div>
            </Col>
            <Col md="auto">
                      ...
                      <div className="mt-4 pt-3 border-top px-3 d-flex gap-2">
                        ...
                        {opening && opening.log_status === 'manager_verified' && (
                          <Button
                            ...
                            className="admin-daily-stock-logs-btn-pill-action border-2"
                            onClick={() => handleRequestCorrection(opening)}
                          >
                        ...
                        {closing && closing.log_status === 'manager_verified' && (
                          <Button
                            variant="outline-warning"
                            className="admin-daily-stock-logs-btn-pill-action border-2"
                            onClick={() => handleRequestCorrection(closing)}
                          >
      ...
      <Modal show={showCorrectionModal} onHide={() => !sendingCorrection && setShowCorrectionModal(false)} centered>
        ...
        <Modal.Body className="p-4">
          ...
          <Form.Group className="mt-3">
            <Form.Label className="fw-semibold">
              Correction Reason / Details <span className="text-danger">*</span>
            </Form.Label>
            <Form.Control
              as="textarea"
              rows={4}
        ...
        <Modal.Footer className="border-0 pt-0 px-4 pb-4">
          <Button variant="outline-secondary" className="rounded-pill px-4" onClick={() => setShowCorrectionModal(false)} disabled={sendingCorrection}>
            Cancel
          </Button>
