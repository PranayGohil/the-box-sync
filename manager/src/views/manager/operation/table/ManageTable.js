...
const customStyles = `
  .manage-table-custom-btn-outline {
    border: 1px solid #23b3f4 !important;
    color: #23b3f4 !important;
    background-color: #fff !important;
    transition: all 0.2s ease-in-out !important;
  }
  .manage-table-custom-btn-outline:hover {
    ...
    return (
      <div className="container-fluid pb-5">
        ...
        <div className="text-center py-5">
          ...
          <p className="mt-2 text-muted fw-bold">Optimizing layout...</p>
        </div>
      </div>
    );
  }
        ...
        <Row className="g-0 align-items-center">
          ...
          <Col xs="12" md="5" className="d-flex justify-content-md-end gap-2 mt-3 mt-md-0">
            <Button
              ...
              className="px-4 py-2 rounded-pill d-flex align-items-center manage-table-custom-btn-outline border-0 shadow-sm"
            >
