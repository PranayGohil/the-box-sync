...
const OrderDetails = () => {
  ...
  const sendWhatsAppMessage = async (phoneVal) => {
    ...
    try {
      ...
      if (whatsappUrl) {
        ...
        toast.error('Unable to generate WhatsApp message');
      }
    } catch (err) {
  ...
  return (
    <div className="container-fluid qsr-page-container">
            ...
            <Card.Body className="pt-2 px-4 pb-4">
              <div className="mb-4">
                ...
                <div className="mb-2 d-flex align-items-center">
                  ...
                  <span className="fw-bold me-1 text-dark">Contact:</span> <span className="text-muted">{order.customer_phone || <span className="text-danger fst-italic">Not set</span>}</span>
                </div>
      ...
      {/* WhatsApp Modal */}
      <Modal show={showWhatsAppModal} onHide={() => setShowWhatsAppModal(false)} centered dialogClassName="modal-custom-whatsapp">
        <style>{`
