                                ...
                                <Card className="leave-card border-0 h-100 shadow-sm">
                                    <Card.Body className="p-4">
                                        <div className="d-flex justify-content-between align-items-start mb-4">
                                            ...
                                            >
                                                <CsLineIcons icon="history" size="14" /> View History
                                            </Button>
                                        </div>
