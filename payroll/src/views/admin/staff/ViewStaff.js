...
import { Button, Row, Col, Card, Spinner, Alert, Dropdown } from 'react-bootstrap';
      ...
      <div className="page-title-container mb-5">
        <Row className="g-3 align-items-center">
          ...
          <Col md={8} className="d-flex flex-wrap justify-content-md-end gap-2 align-items-center">
            ...
            <Button className="custom-btn-outline px-3 py-2 d-flex align-items-center gap-2" onClick={() => history.push('/staff/attendance')}>
              <CsLineIcons icon="calendar" size="18" /> Attendance
            </Button>
            <Button className="custom-btn-outline px-3 py-2 d-flex align-items-center gap-2" onClick={() => history.push('/staff/payroll')}>
              <CsLineIcons icon="wallet" size="18" /> Payroll
            </Button>
            <Dropdown className="d-inline-block">
              <Dropdown.Toggle className="custom-btn-outline px-3 py-2 d-flex align-items-center gap-2 hr-dropdown-toggle">
                <CsLineIcons icon="more-horizontal" size="18" /> HR Actions
              </Dropdown.Toggle>
              <Dropdown.Menu className="glass-card border-0 shadow-lg p-2 mt-2">
                <Dropdown.Item className="rounded-pill mb-1" onClick={() => history.push('/staff/leave-requests')}>Leave Requests</Dropdown.Item>
                <Dropdown.Item className="rounded-pill mb-1" onClick={() => history.push('/staff/leave-policy')}>Leave Policy Config</Dropdown.Item>
                <Dropdown.Item className="rounded-pill mb-1" onClick={() => history.push('/staff/holidays')}>Holiday Calendar</Dropdown.Item>
                <Dropdown.Item className="rounded-pill" onClick={() => history.push('/staff/salary-advances')}>Salary Advances</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </Col>
        </Row>
