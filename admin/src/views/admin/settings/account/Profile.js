...
import { Button, Form, Card, Col, Row, Image, Spinner, Alert, Badge, Modal } from 'react-bootstrap';
...
const Profile = () => {
  ...
  const handleComplianceSave = async () => {
    ...
    try {
      ...
      setComplianceError(err.response?.data?.message || `Failed to update ${type}.`);
    } finally {
      setComplianceSaving(false);
    }
  };
                ...
                <Card className="profile-glass-card border-0 mb-4 text-center">
                  <Card.Body className="p-4 d-flex flex-column align-items-center">
                    ...
                    <div className="w-100 mt-auto">
                      ...
                      />
                      {!logoFile ? (
                        <Button as="label" htmlFor="logo-upload" className="profile-custom-btn-outline w-100 mb-2" disabled={uploadingLogo || saving} style={{ cursor: 'pointer' }}>
                ...
                <Card className="profile-glass-card border-0 h-100">
                  <Card.Body className="p-4">
                    <div className="d-flex profile-profile-header-container align-items-center justify-content-between mb-4">
                      ...
                      {!editMode && (
                        <Button variant="none" className="profile-custom-btn-outline w-md-auto w-100 mt-md-0 mt-2 profile-edit-btn-desktop" onClick={() => setEditMode(true)}>
                      ...
                      <Col md={6}>
                        <Form.Group>
                          ...
                          <Form.Control
                              ...
                              className={!editMode ? 'bg-light border-0 px-3 py-2 fw-bold' : 'bg-light text-muted'}
                            />
