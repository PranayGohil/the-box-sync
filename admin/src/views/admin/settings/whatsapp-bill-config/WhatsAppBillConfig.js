      ...
      <div className="qsr-page-title-container">
        <Row className="g-0 align-items-center">
          ...
          <Col xs="auto" className="d-none d-lg-block">
            <Button
              onClick={() => history.push('/settings/print-config')}
            ...
            >
              <CsLineIcons icon="print" size="18" className="me-2" /> Print Settings
            </Button>
          </Col>
        </Row>
        ...
        <div className="mt-2 d-lg-none d-flex justify-content-start">
          <Button
            ...
            style={{ borderRadius: '50px', borderColor: '#1ea8e7', color: '#1ea8e7', fontWeight: '700' }}
          >
            <CsLineIcons icon="print" size="16" className="me-2" /> Print Settings
          </Button>
        </div>
      </div>
            ...
            <Card.Body>
              {loading ? (
                ...
                <Form onSubmit={formik.handleSubmit}>
                  <Row className="mb-4">
                    <Col xs="12">
                      <h4 className="small-title">WhatsApp Bill Message Content</h4>
                  ...
                  <Row className="mb-4">
                    <Col xs="12">
                      <h4 className="small-title">Custom Header & Footer Messages</h4>
