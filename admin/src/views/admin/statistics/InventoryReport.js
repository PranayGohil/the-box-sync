    ...
    <>
            ...
            <Card.Body className="p-4">
              ...
              <div className="d-flex flex-wrap mb-4">
                {PRESETS.map((p) => (
                  <Button
                    key={p.label}
                    variant={activePreset === p.label ? 'primary' : 'outline-primary'}
                    className="inventory-report-preset-pill"
          ...
          <Card.Body className="p-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            <div className="d-flex gap-3 align-items-center">
              <Button
                ...
                className="inventory-report-custom-btn-outline border-success text-success px-4"
              ...
              <Button
                ...
                className="inventory-report-custom-btn-outline border-danger text-danger px-4"
                        ...
                        <tbody>
                          {statsData.vendorPerformance.slice(0, 5).map((vendor, idx) => (
                            <tr key={idx} style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                              <td className="py-3">
                                <div className="d-flex align-items-center gap-3">
                                  <div className="sw-4 sh-4 rounded-circle d-flex justify-content-center align-items-center bg-primary bg-opacity-10 text-primary fw-bold smaller">
                                    {idx + 1}
                                  </div>
                                  <div>
      ...
      <Modal show={showExportModal} onHide={() => setShowExportModal(false)} centered contentClassName="interactive-card border-0 shadow-lg">
        ...
        <Modal.Footer className="border-0 p-4 pt-0">
          <Button variant="light" className="inventory-report-custom-btn-outline border-0 text-muted" onClick={() => setShowExportModal(false)}>
            Cancel
          </Button>
          <Button className="inventory-report-custom-btn-outline px-4" onClick={handleExportConfirm}>
            Generate Audit
          </Button>
        </Modal.Footer>
      </Modal>
