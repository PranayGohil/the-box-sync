    ...
    <div className="container-fluid qsr-page-container">
      ...
      <div className="qsr-page-title-container">
        <Row className="g-3 align-items-center">
          ...
          <Col md={5} className="d-flex justify-content-md-end gap-2">
            <Button
              className="manage-attendance-custom-btn-outline px-4 py-2 d-flex align-items-center gap-2"
      ...
      {error && (
        <Alert variant="danger" className="manage-attendance-glass-card border-0 mb-4 d-flex align-items-center justify-content-between p-4 shadow-sm">
          ...
          <Button className="manage-attendance-custom-btn-danger-outline px-4" onClick={fetchTodayAttendance}>
            Retry
          </Button>
        </Alert>
      )}
      ...
      <Card className="manage-attendance-glass-card border-0 shadow-sm overflow-hidden mb-5">
        <div className="p-4 border-bottom bg-light d-flex flex-wrap justify-content-between align-items-center gap-3">
          <div>
            <h5 className="fw-bold text-dark mb-1">Daily Roster — {formatDateDisplay(getTodayDate())}</h5>
            <div className="text-muted small fw-medium">Tracking {staffList.length} staff members today</div>
          </div>
          <div className="d-flex flex-wrap gap-2">
            <Badge bg="warning" className="manage-attendance-status-badge">
              Pending
            </Badge>
            <Badge bg="success" className="manage-attendance-status-badge">
              Checked In
            </Badge>
            <Badge bg="primary" className="manage-attendance-status-badge">
              Completed
            </Badge>
            <Badge bg="danger" className="manage-attendance-status-badge">
              Absent
            </Badge>
          </div>
        </div>
