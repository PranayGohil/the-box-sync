...
const ViewAttendance = () => {
  ...
  const calculateWorkingHours = (inTime, outTime) => {
    ...
    let totalMinutes = outTimeParsed.hours * 60 + outTimeParsed.minutes - (inTimeParsed.hours * 60 + inTimeParsed.minutes);
    ...
    try {
      ...
      if (exportOptions.includeDetailedRecords) {
        ...
        const recordsToExport =
          exportOptions.recordsLimit === 'all' ? filteredAttendance : filteredAttendance.slice(0, parseInt(exportOptions.recordsLimit, 10));
