...
const OrderHistory = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <div className="container-fluid mobile-order-history-container">
                ...
                <Row className="g-3">
                  ...
                  <Col xs="6" sm="6" md="3">
                    ...
                    <div className="position-relative w-100">
                      <div
                        className="form-control rounded-pill px-3 border-0 shadow-sm text-dark d-flex align-items-center justify-content-between"
