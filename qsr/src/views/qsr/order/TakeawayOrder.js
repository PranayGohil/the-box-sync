...
const TakeawayOrder = () => {
  ...
  const title = `${isEditMode ? 'Edit' : 'New'} Takeaway Order`;
  ...
  async function fetchOrderDetails() {
    try {
      ...
      const detectedType = order.order_type || 'Takeaway';
      ...
      <div className="pos-wrapper">
        ...
        <div className="pos-body">
          ...
          <div className="pos-order-panel">
            <div className="pos-order-header"><div className="d-flex justify-content-between align-items-center"><div className="fw-bold" style={{ color: '#23b3f4', fontSize: '13px' }}>Order ({orderItems.length})</div>{tokenNumber && <div style={{ background: 'rgba(35,179,244,0.1)', borderRadius: '50px', padding: '2px 10px', color: '#23b3f4', fontWeight: 800, fontSize: '11px' }}>#{tokenNumber}</div>}</div></div>
