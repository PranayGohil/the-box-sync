...
const AddInventory = () => {
  ...
  const customStyles = `
    ...
    .add-inventory-inventory-container .manage-catalog-custom-btn-outline {
      border: 1px solid #23b3f4 !important;
      color: #23b3f4 !important;
      background-color: #ffffff !important;
    }
    .add-inventory-inventory-container .btn-outline-primary:hover,
    .add-inventory-inventory-container .manage-catalog-custom-btn-outline:hover {
      background-color: #23b3f4 !important;
      color: #ffffff !important;
      box-shadow: 0 4px 12px rgba(35, 179, 244, 0.25) !important;
    }
    .add-inventory-inventory-container .btn-outline-primary:hover svg,
    .add-inventory-inventory-container .manage-catalog-custom-btn-outline:hover svg {
          ...
          <Row className="g-0 align-items-center">
            ...
            <Col xs="auto" className="d-none d-lg-block">
              <Button 
                ...
                className="manage-catalog-custom-btn-outline shadow-sm px-4 py-2 d-flex align-items-center"
            ...
            <Card.Body className="p-4 p-lg-5">
              ...
              <div className="text-start mt-2">
                <Button 
                  ...
                  className="manage-catalog-custom-btn-outline shadow-sm px-4 py-2 fw-bold d-flex align-items-center" 
                  onClick={addItem}
                ...
                <Row className="g-4">
                  ...
                  <Col xs={12} md={12} className="text-end pt-3 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                    ...
                    <Button 
                      type="submit" 
                      variant="primary" 
                      className="manage-catalog-custom-btn-outline border-primary text-primary shadow-sm px-5 py-3 fw-bold d-flex align-items-center justify-content-center" 
                      style={{ borderRadius: '50px', border: '2px solid #23b3f4', color: '#23b3f4' }}
