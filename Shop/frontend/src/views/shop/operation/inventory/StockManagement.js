          ...
          <div className="page-title-container mb-4 mt-5 mt-lg-0">
            <Row className="g-0 align-items-center">
              ...
              <Col xs="12" md="auto" className="d-flex justify-content-md-end gap-2 mt-3 mt-md-0">
                <Button onClick={() => history.goBack()} className="manage-catalog-custom-btn-outline shadow-sm border-0 px-4 py-2">
                  <CsLineIcons icon="arrow-left" size="18" className="me-2" /> Back
                </Button>
                <Button href="/operations/daily-stock-logs" className="manage-catalog-custom-btn-outline shadow-sm border-0 px-4 py-2">
                  <CsLineIcons icon="file-text" size="18" className="me-2" /> <span className="d-none d-sm-inline">Audit Logs</span>
                </Button>
                <Button href="/operations/wastage-log" className="manage-catalog-custom-btn-outline border-danger text-danger shadow-sm border-0 px-4 py-2" style={{color: '#ef4444', borderColor: '#ef4444'}}>
