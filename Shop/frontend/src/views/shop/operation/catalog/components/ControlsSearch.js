...
const ControlsSearch = ({ tableInstance }) => {
    ...
    return (
        <div className="manage-catalog-search-container">
            <input
                className="form-control pill-input manage-catalog-pill-input"
                value={value || ''}
                onChange={(e) => {
            ...
            />
            <div className="manage-catalog-search-icon-wrapper">
