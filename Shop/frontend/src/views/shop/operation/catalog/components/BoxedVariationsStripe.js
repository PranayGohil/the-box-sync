      ...
      <div className="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom" style={{ borderColor: 'rgba(35, 179, 244, 0.1)' }}>
        ...
        <div className="d-flex gap-2">
          <Button
            variant="link"
            size="sm"
            className="p-1 text-muted manage-catalog-custom-icon-btn"
            onClick={() => {
          ...
          <Button
            variant="link"
            size="sm"
            className="p-1 manage-catalog-text-primary manage-catalog-custom-icon-btn"
            onClick={() => {
              history.push('/operations/add-item', {
                category: category.category,
                fromManageCatalog: true,
              });
            }}
