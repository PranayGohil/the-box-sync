...
// ============================================
// GET /api/statistics/items/top?period=week|month|year&limit=10&category=CategoryName&start_date=YYYY-MM-DD&end_date=YYYY-MM-DD
statisticsRouter.get("/items/top", authMiddleware, getTopDishes);

// GET /api/statistics/items/low-performing?period=month|year&threshold=5&start_date=YYYY-MM-DD&end_date=YYYY-MM-DD
...
statisticsRouter.get("/catalog/report", authMiddleware, getMenuPerformanceReport);
