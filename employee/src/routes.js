...
const manager = {
  dashboard: lazy(() => import('views/attendance/Dashboard')),
};

const order = {
  dinein: lazy(() => import('views/attendance/order/DineInOrder')),
}
const dashboards = {
...
const allRoutes = {
  mainMenuItems: [
    ...
    },
    {
      ...
      label: 'Attendance',
      icon: 'clock',
      component: lazy(() => import('views/attendance/ViewAttendance')),
      roles: ['staff'],
    },
    {
      ...
      label: 'Payroll',
      icon: 'dollar',
      component: lazy(() => import('views/attendance/ViewStaffPayroll')),
      roles: ['staff'],
    },
    {
    ...
    },
    {
      ...
      label: 'Profile',
      icon: 'user',
      component: lazy(() => import('views/attendance/StaffProfile')),
      roles: ['staff'],
      hideInMenu: true,
    },
    {
