...
const styles = `
  ...
  .dish-table thead th { font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.05em; color: #94a3b8; font-weight: 700; border: none; padding: 0.6rem 0.85rem; background: #f8fafc; }
  .dish-table tbody td { border: none; border-bottom: 1px solid #f1f5f9; padding: 0.6rem 0.85rem; color: #334155; vertical-align: middle; }
                  ...
                  <tr key={idx}>
                    <td>
                      ...
                      {item.status && item.status !== 'Completed' && (
                        <div className="dish-sub">Status: {item.status}</div>
                      )}
                    </td>
                    <td>
