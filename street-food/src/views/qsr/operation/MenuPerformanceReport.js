...
const MenuPerformanceReport = () => {
  ...
  const breadcrumbs = [
    ...
    { to: 'operations/menu-performance', text: 'Menu Performance' },
  ];
            ...
            <Card className="menu-performance-report-interactive-card border-0 shadow-sm mb-4">
              <Card.Body className="p-4">
                ...
                {filteredDishes.length > dishPerPage && (
                  <div className="d-flex justify-content-center mt-4">
                    <ReportPagination currentPage={dishPage} totalPages={Math.ceil(filteredDishes.length / dishPerPage)} onChangePage={setDishPage} />
                  </div>
                )}
              </Card.Body>
            </Card>
