...
const Login = () => {
  const title = 'Login — The Box Captain';
  const description = 'Secure table service login to The Box Captain panel.';
      ...
      <div className="login-login-page-wrapper">
        ...
        <div className="login-login-left-panel">
          ...
          <p className="login-login-hero-sub">
            Real-time table order taking, direct kitchen synchronization, interactive seating control, and lightning-fast customer service.
          </p>
          <div className="login-login-feature-pills">
            {[
              ...
              'Lightning-Fast Ticket Management',
            ].map((f) => (
        ...
        <div className="login-login-right-panel">
            ...
            <div className="login-auth-input-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  type="text"
                  name="username"
                  placeholder="Captain operator username"
          ...
          <div className="login-auth-footer-link" style={{ fontSize: '0.8rem', lineHeight: '1.5' }}>
            To create or manage captain operator credentials, please use your <strong>Admin Dashboard</strong>.
          </div>
