...
const Register = () => {
  ...
  const description = 'Create your shop account on TheBoxSync.';
  ...
  const rightSide = (
    <div className="login-login-right-panel">
      <div className="login-login-form-header">
        <div className="login-login-form-eyebrow">Shop Registration</div>
        <h2 className="login-login-form-title">Create your account</h2>
        <p className="login-login-form-subtitle">Set up your shop on TheBoxSync platform</p>
      </div>
      <div className="wizard wizard-default">
        <Wizard>
          ...
          />
          <Steps>
            <Step id="step1" name="Shop" desc="Basic Info">
                ...
                {({ errors, touched, setFieldValue, values, setFieldError, setFieldTouched }) => (
                  <Form>
                    <div className="login-auth-input-group">
                      <label className="login-auth-input-label">SHOP NAME</label>
                      <div style={{ position: 'relative' }}>
                        <span className="login-auth-input-icon">
                          <CsLineIcons icon="shop" size="18" />
                        </span>
                        <Field className="login-auth-input form-control" name="name" placeholder="Enter Shop name" />
                      </div>
                    ...
                    <div className="login-auth-input-group">
                      <label className="login-auth-input-label">SHOP TYPE</label>
                      <div style={{ position: 'relative' }}>
                        <span className="login-auth-input-icon">
                          <CsLineIcons icon="tag" size="18" />
                        </span>
                        <Field as="select" className="login-auth-input form-control" name="shop_type" style={{ paddingLeft: '2.5rem', cursor: 'pointer' }}>
                          ...
                          <option value="Farshan Shop">Farshan Shop</option>
                          <option value="Bakery">Bakery</option>
                          <option value="Ice Cream Parlour">Ice Cream Parlour</option>
                          <option value="Dairy / Milk Shop">Dairy / Milk Shop</option>
                          <option value="Juice & Snack Bar">Juice & Snack Bar</option>
                          <option value="Vegetable / Fruit Shop">Vegetable / Fruit Shop</option>
                          <option value="Meat & Poultry Shop">Meat & Poultry Shop</option>
                          ...
                          <option value="Bouquet & Flower Shop">Bouquet & Flower Shop</option>
                          <option value="Sports Shop">Sports Shop</option>
                          <option value="Liquor / Wine Shop">Liquor / Wine Shop</option>
                          <option value="Other">Other</option>
                        </Field>
                      </div>
                      {errors.shop_type && touched.shop_type && (
                        <div className="login-auth-error-msg">
                          <CsLineIcons icon="warning" size="13" />
                          {errors.shop_type}
                        </div>
