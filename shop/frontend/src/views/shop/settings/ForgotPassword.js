...
function ForgotPassword() {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API}/user/send-otp`, { email, login_from: 'shop' });
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API}/user/verify-otp`, { email, otp, login_from: 'shop' });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API}/user/reset-password`, { email, newPassword, login_from: 'shop' });
      setSuccess(response.data.message);
  ...
  return (
    <div className="container-fluid qsr-page-container">
      ...
      <Row className="justify-content-start">
        <Col xs={12} lg={8} xl={6}>
          <Card className="profile-glass-card border-0 mb-5 overflow-hidden">
              ...
              {step === 2 && (
                <Form onSubmit={handleVerifyOtp}>
                  ...
                  <div className="d-flex profile-button-group-responsive justify-content-between align-items-center gap-3">
                    ...
                    <Button variant="none" className="profile-custom-btn-outline px-4 py-2" onClick={() => setStep(1)} disabled={isLoading}>
