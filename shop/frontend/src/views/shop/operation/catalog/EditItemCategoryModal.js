                ...
                <Row className="w-100 g-2 m-0 justify-content-end">
                    <Col xs={6} sm="auto" className="px-1">
                        <Button
                            ...
                            onClick={handleClose}
                            disabled={isSubmitting}
                            className="rounded-pill w-100 fw-bold edit-item-category-modal-custom-btn-outline btn btn-outline-primary"
                        >
                            Cancel
                        </Button>
                    </Col>
                    <Col xs={6} sm="auto" className="px-1">
                        <Button
                            ...
                            disabled={isSubmitting}
                            className="rounded-pill fw-bold w-100 py-2 edit-item-category-modal-custom-btn-outline d-flex align-items-center justify-content-center gap-1 gap-sm-2"
                        >
                            {isSubmitting ? (
                                <>
