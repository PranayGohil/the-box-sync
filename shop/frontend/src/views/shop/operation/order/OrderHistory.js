...
const OrderHistory = () => {
  ...
  const description = 'Sales history with advanced filters.';
  ...
  const exportToExcel = async () => {
    ...
    try {
      ...
      if (orders.length === 0) throw new Error('No sales found for the selected filters');
      ...
      <div className="container-fluid qsr-page-container mobile-order-history-container">
        ...
        {data.length === 0 && !loading ? (
          ...
          >
            ...
            No sales found. {searchTerm || getActiveFilterCount() > 0 ? 'Try adjusting your search or filters.' : 'Sales will appear here once created.'}
          </Alert>
        ) : (
          <>
