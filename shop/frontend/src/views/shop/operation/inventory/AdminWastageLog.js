...
const AdminWastageLog = () => {
  ...
  const customStyles = `
    ...
    .admin-wastage-log-wastage-container .manage-catalog-custom-btn-outline {
      border: 1px solid #23b3f4 !important;
      color: #23b3f4 !important;
      background-color: #ffffff !important;
    }
    .admin-wastage-log-wastage-container .btn-outline-primary:hover,
    .admin-wastage-log-wastage-container .manage-catalog-custom-btn-outline:hover {
      background-color: #23b3f4 !important;
      color: #ffffff !important;
      box-shadow: 0 4px 12px rgba(35, 179, 244, 0.25) !important;
    }
    .admin-wastage-log-wastage-container .btn-outline-primary:hover svg,
    .admin-wastage-log-wastage-container .manage-catalog-custom-btn-outline:hover svg {
          ...
          <Card className="admin-wastage-log-page-card border-0 mb-4">
            <Card.Body className="p-4">
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Button variant="danger" type="submit" className="w-100 manage-catalog-custom-btn-outline border-danger text-danger shadow-sm py-3 d-flex align-items-center justify-content-center" style={{color: '#ef4444', borderColor: '#ef4444'}} disabled={submitting}>
