...
const AdminDailyStockLogs = () => {
  ...
  const customStyles = `
    ...
    .admin-daily-stock-logs-stock-container .manage-catalog-custom-btn-outline {
      border: 1px solid #23b3f4 !important;
      color: #23b3f4 !important;
      background-color: #ffffff !important;
    }
    .admin-daily-stock-logs-stock-container .btn-outline-primary:hover,
    .admin-daily-stock-logs-stock-container .manage-catalog-custom-btn-outline:hover {
      background-color: #23b3f4 !important;
      color: #ffffff !important;
      box-shadow: 0 4px 12px rgba(35, 179, 244, 0.25) !important;
    }
    .admin-daily-stock-logs-stock-container .btn-outline-primary:hover svg,
    .admin-daily-stock-logs-stock-container .manage-catalog-custom-btn-outline:hover svg {
      ...
      <div className="container-fluid px-lg-5">
        <div className="page-title-container mb-4 mt-5 mt-lg-0">
          <Row className="g-0 align-items-center">
            ...
            <Col xs="auto">
              <Button onClick={() => history.goBack()} className="manage-catalog-custom-btn-outline shadow-sm border-0 px-3 py-2">
