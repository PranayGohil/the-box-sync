...
import MainMenu from './main-catalog/MainMenu';
import NavLogo from './NavLogo';
import NavMobileButtons from './NavMobileButtons';
import { menuChangeAttrMenuAnimate, menuChangeCollapseAll } from './main-catalog/catalogSlice';
...
const Nav = () => {
  ...
  const { navClasses, placementStatus, behaviourStatus, attrMobile, menuPadding } = useSelector((state) => state.catalog);
  const mouseActionTimer = useRef(null);

  // Vertical catalog semihidden state showing
  ...
  // Vertical catalog semihidden state hiding
