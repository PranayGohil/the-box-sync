...
import { menuChangeAttrMobile, menuChangeNavClasses } from './main-catalog/catalogSlice';
...
const NavMobileButtons = () => {
  ...
  // Starts mobile catalog opening sequence
  ...
  // Starts mobile catalog closing sequence
  ...
  return (
    <div className="mobile-buttons-container">
      ...
      <a href="#/" id="mobileMenuButton" className="catalog-button" onClick={showMobileMenu}>
        <CsLineIcons icon="catalog" />
      </a>
    </div>
  );
};
